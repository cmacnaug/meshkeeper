...
public class ControlServer {
  ...
  public static final String REMOTING_URI_PATH = Registry.MESH_KEEPER_ROOT
      + "/control/remoting-uri";
  public static final String EVENTING_URI_PATH = Registry.MESH_KEEPER_ROOT
      + "/control/eventing-uri";
  public static final String REPOSITORY_URI_PATH = Registry.MESH_KEEPER_ROOT
      + "/control/repository-uri";
  ...
  public void start() throws Exception {
    ...
    try {
      ...
      log.info("MeshKeeper Successfully started. The Registry Service is listening on: "
          + getRegistryUri());
      ...
      if(propsLock == null) {
        ...
        if(f.exists()) {
          ...
          while(propsLock == null) {
            try {
              if(first) {
                propsLock = new RandomAccessFile(getPropsFile(), "r").getChannel().tryLock(0, Long.MAX_VALUE, true);
                if(propsLock == null) {
              ...
              propsLock = new RandomAccessFile(getPropsFile(), "r").getChannel().lock(0, Long.MAX_VALUE, true);
